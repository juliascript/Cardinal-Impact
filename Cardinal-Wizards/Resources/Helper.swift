...
struct StanfordColor {

    static let darkgreen = Helper.colorWithHexString(hex: "#175E54")
    static let red = Helper.colorWithHexString(hex: "#8C1515")
}
class Helper {
    ...
    static func decacheUser() {
        ...
        try? storage!.removeObject(forKey: "currentUser")
    }
    ...
    static func getCurrentTime() -> String {
        ...
        //        let month = calendar.monthSymbols[monthDate-1]
...
extension UIButton {
    ...
    override func roundAndShadow(radius:CGFloat=5, opacity:Float=0.5, borderWidth: CGFloat=0, borderColor: CGColor=UIColor.brown.cgColor) {
        self.layer.masksToBounds = false;
        self.layer.cornerRadius = radius;
        self.layer.shadowOffset = CGSize(width: -1,height: 1);
        self.layer.shadowOpacity = opacity;
